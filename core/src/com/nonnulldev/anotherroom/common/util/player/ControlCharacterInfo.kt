package com.nonnulldev.anotherroom.common.util.player
...
class ControlCharacterInfo {

	private val FILE_PATH = "player/controlCharacterInfo.json"
	...
	companion object {
		...
		private val log = Logger(ControlCharacterInfo::class.java.name, Logger.DEBUG)
